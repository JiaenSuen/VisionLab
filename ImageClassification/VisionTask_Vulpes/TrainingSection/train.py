...
from TrainingSection.dataset import FoxSpeciesDataset, NUM_CLASSES, DATASET_NAME
...
def Train(modelName="", device="cuda", epochs=100):
    ...
    train_loader = FoxSpeciesDataset.GetTrainLoader(
        batch_size=config["batch_size"],
        augment=True,
    )

    # Data Loader for final train accuracy, without augmentation
    train_eval_loader = FoxSpeciesDataset.GetTrainLoader(
    ...
    best_model = modelRouter[modelName](num_classes=NUM_CLASSES)
